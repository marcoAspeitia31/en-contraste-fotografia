...
function en_contraste_fotografia_scripts() {
	wp_enqueue_style( 'en-contraste-fotografia-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'en-contraste-fotografia-style', 'rtl', 'replace' );

	wp_enqueue_script( 'en-contraste-fotografia-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
