(function ($) {
    ...
    key: object.theme_options.google_api_key,
    v: "weekly",
    ...
    async function initMap() {
        ...
        const position = { lat: Number( object.theme_options.location.latitude ), lng: Number( object.theme_options.location.longitude ) };
        ...
        const marker = new AdvancedMarkerElement({
            map: map,
            position: position,
            title: object.theme_options.business_address,
        });
    }
